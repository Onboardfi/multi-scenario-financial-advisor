export class Api {
  ...
  // Add Langfuse API methods
  async getLangfuseTraces(limit?: number, offset?: number) {
    return this.fetchFromApi('/api/v1/langfuse/traces', {}, { limit, offset });
  }
  ...
  async getCurrentApiUser() {
    return this.fetchFromApi(`/api-users/me`);
  }
